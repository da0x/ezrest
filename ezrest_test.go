...
func TestApiGET(t *testing.T) {
	...
	statusCode, err := Get("http://dummy.restapiexample.com/api/v1/employees", DefaultHeaders(), &response)
	if err != nil {
...
func TestApiGET404(t *testing.T) {
	var response getResponse
	_, err := Get("http://dummy.restapiexample.com/api/v1/eoyees", DefaultHeaders(), &response)
	if err == nil {
...
func TestApiPOST(t *testing.T) {
	...
	statusCode, err := Post("http://dummy.restapiexample.com/api/v1/create", DefaultHeaders(), body, &response)
	if err != nil {
